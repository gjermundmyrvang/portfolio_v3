...
function Page({ title, link }: PageComponent) {
  return (
    <div className="snap-center transform-[scaleY(-1)] w-80 sm:w-90 shrink-0 h-full flex flex-col border-3 border-black shadow-[6px_6px_0px_0px_#000] dark:shadow-none">
      <div className="px-2 py-4 border-b-3 border-black bg-neutral-100">
        <Link href={link}>
